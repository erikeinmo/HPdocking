function Get-HPDockUpdateDetails {
    ...
    function Get-HPDockInfo {
        ...
        $Url_EssG5 = 'https://ftp.hp.com/pub/softpaq/sp152001-152500/sp152201.exe'  #  01.00.12.00 | Apr 16, 2024
        ...
        #USB-C Dock G5
        $Url_UsbG5 = 'https://ftp.hp.com/pub/softpaq/sp151501-152000/sp151931.exe'  #  1.0.20.0 rev1 | Mar 25, 2024
